...
To install Riot app on [Windows / MacOS](https://riot.im/desktop.html), [Debian](http://data.agaric.com/how-install-riot-desktop-matrix-client-debian-based-systems) and [Build from Source](https://github.com/vector-im/riot-web#running-as-a-desktop-app)

## Login

1. To login, fill out username and password then custom server

![alt text](https://i.imgur.com/LYmpT8c.png "Login")
